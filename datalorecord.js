...
const dataloreInfo = {
	"armorall":"Armorall: +3 Armor, +1 Max NRG, +1 SPD",
	...
	"blue lander":"Blue Lander: +1 MaxHP. Full HP restore.",
	...
	"crisis overdrive":"Crisis Overdrive: Once Per Run. +3 ATK, +3 PWR, +4 SPD, +4 JMP while in red health.)",
	...
	"forcemetal shell":"Forcemetal Shell: +2 Max HP, +2 ATK, -2 SPD.",
	...
	"fortune stabilsier":"Fortune Stabilsier: Once Per Run. Starting next level, shops and slotmachines will always in the boss hallway.",
	"gapminder":"Gapminder: Once Per Run. Prevents fall damage.",
	"glass cannon":"Glass Cannon: +2 ATK, +2 PWR, -2 Max HP.",
	...
	"hoarders might":"Hoarder's Might: Once Per Run. Gain bonus ATK/PWR for unspent nuts. (+1 ATK/PWR per 20 nuts.)",
	...
	"kinetic converter":"Kinetic Converter: +4 SPD, +4 JMP, -2 ATK, -1 PWR.",
	...
	"leafmetal plating":"Leafmetal Plating: +4 SPD, +4 JMP, -2 Max HP",
	...
	"striking feather":"Striking Feather: +2 Max HP, +2 Max NRG, +2 PWR, -2 ATK.",
