...
const dataloreInfo = {
	"armorall":"Armorall: +1 Max NRG/SPD, +3 Armor.",
	"armorative plating":"Armorative Plating: +2 Armor at level start.",
	"armor bloom":"Armor Bloom: +6 armor.",
	"armor nut":"Armor Nut: Nuts sometimes grant 1 armor. (10% chance on regular nut, 33% chance on golden nut.)",
	"armor scavenger":"Armor Scavenger: +1 Armor. Armor drop rate increased.",
	"armor spreader":"Armor Spreader: Armor capsules are worth 1 more armor. Armor Bloom is worth 2 more armor.",
	"band of might":"Band of Might: +2 ATK.",
	"blue lander":"Blue Lander: +1 Max HP. Full HP restore.",
	"boltdash":"Boltdash: Once Per Run. Dash speed increased by 25%. Shortens dash length.",
	"bracer of battle":"Bracer of Battle: +5 ATK.",
	"brain food lunch":"Brain Food Lunch: +2 Max HP, +4 Max NRG. Full NRG restore.",
	"case resonator":"Case Resonator: Once Per Run. Increases the effects of equipped Body Cores. Resonated effects listed under respective Core Augs.",
	"charged nuts":"Charged Nuts: Nuts sometimes restore 1 NRG. (10% chance on regular nut, 100% chance on golden nut.)",
	"charging magnet":"Charging Magnet: Once Per Run. Charging draws in pickups in clockwise orbit.",
	"choicebooster":"Choicebooster: Once Per Run. Shops contain an additional item. Can stack if more than one is acquired. (Hysteria, Cheating, Save Editing.)",
	"contractor omega":"Contractor Omega: +3 Max HP/Max NRG/ATK/PWR/SPD/JMP.",
	"contractor plus":"Contractor Plus: +1 Max HP/Max NRG/ATK/PWR/SPD/JMP.",
	"cranial resonator":"Cranial Resonator: Once Per Run. Increases the effects of equipped Head Cores. Resonated effects listed under respective Core Augs.",
	"crisis lifebank":"Crisis Lifebank: Picks up health drops and when player health becomes red, explodes to release half the health it had stored.",
	"crisis overdrive":"Crisis Overdrive: Once Per Run. +3 ATK/PWR, +4 SPD/JMP while in red health.)",
	"crisis timestopper":"Crisis Timestopper: Once Per Run. Temporarily freezes all foes when a hit knocks you into red health.",
	"deconstructor's might":"Deconstructor's Might: Once Per Run. Defeated enemies explode, dealing 12(?) damage to other nearby enemies.",
	"enerative plating":"Enerative Plating: Full NRG restore at level start.",
	"energy scavenger":"Energy Scavenger: +1 PWR. Enemies have a chance to explode into 3-5 NRG pellets.",
	"entropy lock":"Entropy Lock: Once Per Run. Slot Machines will skip empty rolls and always guarantee a prize. (HP/NRG/Nuts/Armor do not count as empty rolls.)",
	"forcemetal shell":"Forcemetal Shell: +2 Max HP/ATK. -2 SPD.",
	"force resonator":"Force Resonator: Once Per Run. Increases the effects of equipped Arm Cores. Resonated effects listed under respective Core Augs.",
	"forgotten memento":"Forgotten Memento: Once Per Run. +3 PWR. Can spend nuts to cast powers at 0 NRG. 2 nuts per power cast.)",
	"fortune stabiliser":"Fortune Stabiliser: Once Per Run. Starting next level, shops and slotmachines will always in the boss hallway.",
	"gapminder":"Gapminder: Once Per Run. Prevents fall damage.",
	"glass cannon":"Glass Cannon: +2 ATK/PWR. -2 Max HP.",
	"health nut":"Health Nut: Nuts sometimes restore 1 HP. (10% chance on regular nut, 50% chance on golden nut.)",
	"heart container":"Heart Container: +2 Max HP.",
	"hoarder's might":"Hoarder's Might: Once Per Run. Gain bonus ATK/PWR for unspent nuts. (+1 ATK/PWR per 20 nuts.)",
	"hypersash":"Hypersash: +5 SPD.",
	"intensifier":"Intensifier: Once Per Run. Charged attacks deal 20% extra damage.",
	"juiced reserves":"Juiced Reserves: Gain bonus PWR for Current NRG. (+1 PWR per 4 Current NRG.)",
	"kinetic converter":"Kinetic Converter: +4 SPD/JMP. -2 ATK, -1 PWR.",
	"kinetic resonator":"Kinetic Resonator: Increases the effects of equipped Leg Cores.Resonated effects listed under respective Core Augs.",
	"leafmetal plating":"Leafmetal Plating: +4 SPD/JMP. -2 Max HP.",
	"leafpetal":"Leafpetal: +2 SPD, +1 JMP.",
	"life extender":"Life Extender: +1 Max HP.",
	"megaheart":"Megaheart: +4 Max HP.",
	"meganut":"Meganut: +25 Nuts.",
	"minimech o. grinder":"Minimech O. Grinder: Shield repro orbits around you and erases projectiles. Caps at +8 for full shield. Additional Minimechs grant nuts.",
	"mistimed protector":"Mistimed Protector: Once Per Run. Increases your i-frame duration.",
	"mixmatch mastery":"Mixmatch Mastery: Once Per Run. Gain bonus ATK/PWR/SPD/JMP for mixed Core Sets. (+1 for 2 different pieces, +2 for 3, and +4 for 4.)",
	"murderdrone":"Murderdrone: Offensive Repro.",
	"ninja sash":"Ninja Sash: +2 SPD.",
	"nut replicator":"Nut Replicator:At level start, gain bonus nuts equal to 20% of your current unspent nuts. (Can stack but caps at +100 nuts.)",
	"nutsaving stringwire":"Nutsaving Stringwire: Once Per Run. 50% chance to use a vending machine for free.",
	"patchwork connector":"Patchwork Connector: Once Per Run. Set Bonus requirements decreased by one piece. (Does not stack with Patchwork Integrator.)",
	"plumber hat":"Plumber Hat: +4 JMP.",
	"potato battery":"Potato Battery: +3 Max NRG.",
	"power enhancer":"Power Enhancer: +3 PWR.",
	"pure flame":"Pure Flame: +1 PWR on pickup and at level start.",
	"quantum spook":"Quantum Spook: Once Per Run. All attacks ignore walls and shields. (Except boss doors.)",
	"reclaimed spark":"Reclaimed Spark: +1 Max NRG, +1 PWR.",
	"re-flapp":"Re-Flapp: Offensive Repro.",
	"regenerative plating":"Regenerative Plating: +2 HP at level start.",
	"scrapmetal scavenger":"Scrapmetal Scavenger: Enemies have a chance to explode into 5+ nuts.",
	"seven leaf clover":"Seven Leaf Clover: Increases drop rate of all pickups.",
	"shinier token":"Shinier Token: +3 tokens.",
	"shockwave sidekick":"Shockwave Sidekick: Offensive Repro.",
	"skittery smuggler":"Skittery Smuggler: Flies towards dropped nuts, eating 10 of them. Once full, produces 2 random Augs.",
	"spicy incense":"Spicy Incense: +1 ATK on pickup and at level start.",
	"spillover matrix":"Spillover Matrix: Once Per Run. At full health, HP pellets are converted into NRG at a 1:2 ratio.",
	"splintering twinifier":"Splintering Twinifier: Once Per Run. Twinifies all future repros.",
	"static clicklets":"Static Clicklets: Once Per Run. Hold Up while wallsliding to cling to walls.",
	"striking feather":"Striking Feather: +2 Max HP/Max NRG/PWR. -2 ATK.",
	"strongarm band":"Strongarm Band: +1 ATK.",
	"system restore":"System Restore: Once Per Run. Cures you of any already-acquired Prototype penalties.",
	"the rebeginner":"The Rebeginner: Sacrifices himself for you if you die.",
	"the volunteer":"The Volunteer: Once Per Run. Replaces in-level shops with Very Safe Labs starting next level.",
	"thorned hull":"Thorned Hull: Gain bonus ATK for Current HP. (+1 ATK per 4 Current HP.)",
	"thrift actuator":"Thrift Actuator: Starting next level, one shop item is always on sale.",
	"thrillseeker":"Thrillseeker: Once Per Run. Starting next level, every level has a guaranteed Glory Zone.",
	"thunderous boon":"Thunderous Boon: +6 PWR.",
	"tiny flamespewer":"Tiny Flamespewer: Offensive Repro.",
	"unflappable":"Unflappable: Once Per Run. Flapps no longer hurt you. Beta/Gamma flapps will no longer dash at you.",
	"utilifier":"Utilifier: +12 Max NRG. - 5 PWR.",
	"vendsmasher":"Vendsmasher: Once Per Run. Destroyed vending machines give additional pickups. Green/Red Vendors may drop a Heart Container. Blue Vendors may drop a Potato Battery. (Knocking over vending machines with Quint Laser counts as destroying them.)",
	"vibrofocus":"Vibrofocus: +1 Max HP, +4 PWR. -4 Max NRG.",
	"vibroreserve":"Vibroreserve: +6 Max NRG.",
	"vitaboost":"Vitaboost: +1 Max HP, + 1 Max NRG, +1 Armor.",
	"vitality scavenger":"Vitality Scavenger: Restores 2 HP. Enemies have a chance to explode into 3-5 HP pellets.",
	"world slug":"World Slug: Once Per Run. Starting Next Level, Hazards and Platforms slow down.",
	"xcalber":"XCALBER: +2 Max HP, +2 ATK. -2 PWR, -2 Max NRG.",
	"zephyr":"Zephyr: +2 Attack Speed. (Buster shot-limit +2. Melee weapons complete combos quicker. Power cooldown reduced/cast rate increased.) ",
	"zookeeper's sigil":"Zookeeper's Sigil: Repros deal 25% additional damage.",
	"zookeeper's zeal":"Zookeeper's Zeal: Repro fire rate increased by 25%.",
